...
from .user import Users, UsersAdmin, CommentAdmin, Comment
from .projects.models import  Project, ProjectAdmin, Implementation, ImpAdmin
...
def configure_extensions(app):
    ...
    admin.add_view(ProjectAdmin(db.session))
    admin.add_view(ImpAdmin(db.session))
    admin.init_app(app)
